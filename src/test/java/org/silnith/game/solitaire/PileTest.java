...
public class PileTest {
    ...
    public void testPileWithDown() {
        new Pile(Arrays.asList(new Card[] { new Card(FOUR, SPADE),
                new Card(JACK, HEART), new Card(ACE, HEART) }),
    ...
    public void testPileWithUp() {
        new Pile(Arrays.asList(new Card[] {}), Arrays.asList(new Card[] {
                new Card(KING, CLUB), new Card(QUEEN, DIAMOND),
    ...
    public void testPileWithBoth() {
        new Pile(Arrays.asList(new Card[] { new Card(FOUR, SPADE),
                ...
                Arrays.asList(new Card[] { new Card(KING, CLUB),
                        new Card(QUEEN, DIAMOND), new Card(JACK, CLUB),
    ...
    public void testHasFaceDownCards() {
        final Pile pile = new Pile(Arrays.asList(new Card[] {
                new Card(FOUR, SPADE), new Card(JACK, HEART),
                new Card(ACE, HEART) }), Arrays.asList(new Card[] {
                new Card(KING, CLUB), new Card(QUEEN, DIAMOND),
                new Card(JACK, CLUB), new Card(TEN, DIAMOND) }));
    ...
    public void testHasFaceDownCardsNull() {
        final Pile pile = new Pile(null, Arrays.asList(new Card[] {
                new Card(KING, CLUB), new Card(QUEEN, DIAMOND),
                new Card(JACK, CLUB), new Card(TEN, DIAMOND) }));
    ...
    public void testGetTopCards3() {
        ...
        assertEquals(
                Arrays.asList(new Card[] { new Card(QUEEN, DIAMOND),
                        new Card(JACK, CLUB), new Card(TEN, DIAMOND) }),
                pile.getTopCards(3));
    }
    ...
    public void testGetTopCards2() {
        ...
        assertEquals(
                Arrays.asList(new Card[] { new Card(JACK, CLUB),
                        new Card(TEN, DIAMOND) }), pile.getTopCards(2));
    }
    ...
    public void testPileMissingTopCards4() {
        final Pile pile = new Pile(Arrays.asList(new Card[] {
                ...
                new Card(KING, CLUB), new Card(QUEEN, DIAMOND),
                new Card(JACK, CLUB), new Card(TEN, DIAMOND) }));
        final Pile expected = new Pile(Arrays.asList(new Card[] {
                new Card(FOUR, SPADE), new Card(JACK, HEART) }),
    ...
    public void testPileMissingTopCards3() {
        ...
        final Pile expected = new Pile(Arrays.asList(new Card[] {
                new Card(FOUR, SPADE), new Card(JACK, HEART),
                new Card(ACE, HEART) }), Arrays.asList(new Card[] { new Card(
                KING, CLUB) }));
    ...
    public void testAddNewCards1() {
        ...
        assertEquals(expected, pile.addNewCards(Arrays
                .asList(new Card[] { new Card(NINE, CLUB) })));
    }
    ...
    public void testAddNewCards3() {
        ...
        final Pile expected = new Pile(Arrays.asList(new Card[] {
                ...
                new Card(KING, CLUB), new Card(QUEEN, DIAMOND),
                new Card(JACK, CLUB), new Card(TEN, DIAMOND),
                new Card(NINE, CLUB), new Card(EIGHT, DIAMOND),
                new Card(SEVEN, CLUB) }));
    ...
    public void testEquals() {
        final Pile pile1 = new Pile(Arrays.asList(new Card[] {
                new Card(TWO, HEART), new Card(KING, DIAMOND) }),
                Arrays.asList(new Card[] { new Card(EIGHT, SPADE),
                        new Card(SEVEN, DIAMOND), new Card(SIX, CLUB) }));
    ...
    public void testEqualsFaceDownDiffer() {
        final Pile pile1 = new Pile(Arrays.asList(new Card[] {
                ...
                Arrays.asList(new Card[] { new Card(EIGHT, SPADE),
                        new Card(SEVEN, DIAMOND), new Card(SIX, CLUB) }));
        final Pile pile2 = new Pile(Arrays.asList(new Card[] {
                new Card(TWO, SPADE), new Card(KING, DIAMOND) }),
                Arrays.asList(new Card[] { new Card(EIGHT, SPADE),
                        new Card(SEVEN, DIAMOND), new Card(SIX, CLUB) }));
    ...
    public void testEqualsFaceUpDiffer() {
        ...
        final Pile pile2 = new Pile(Arrays.asList(new Card[] {
                new Card(TWO, HEART), new Card(KING, DIAMOND) }),
                Arrays.asList(new Card[] { new Card(EIGHT, SPADE),
                        new Card(SEVEN, HEART), new Card(SIX, CLUB) }));
