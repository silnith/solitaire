...
public class SolitaireTest {
	...
	public void testDeal() {
		...
		piles.add(new Pile(Arrays.asList(new Card(FOUR, CLUB), new Card(TEN, CLUB), new Card(TWO, DIAMOND), new Card(SIX, DIAMOND)), null));
		piles.add(new Pile(Arrays.asList(new Card(FIVE, CLUB), new Card(JACK, CLUB), new Card(THREE, DIAMOND), new Card(SEVEN, DIAMOND), new Card(TEN, DIAMOND)), null));
		piles.add(new Pile(Arrays.asList(new Card(SIX, CLUB), new Card(QUEEN, CLUB), new Card(FOUR, DIAMOND), new Card(EIGHT, DIAMOND), new Card(JACK, DIAMOND), new Card(KING, DIAMOND)), null));
		piles.add(new Pile(Arrays.asList(new Card(SEVEN, CLUB), new Card(KING, CLUB), new Card(FIVE, DIAMOND), new Card(NINE, DIAMOND), new Card(QUEEN, DIAMOND), new Card(ACE, HEART), new Card(TWO, HEART)), null));
		...
		final List<Card> drawPile = Arrays.asList(new Card(THREE, HEART),
				new Card(FOUR, HEART), new Card(FIVE, HEART), new Card(SIX, HEART),
				new Card(SEVEN, HEART), new Card(EIGHT, HEART), new Card(NINE, HEART),
				new Card(TEN, HEART), new Card(JACK, HEART), new Card(QUEEN, HEART),
				new Card(KING, HEART), new Card(ACE, SPADE), new Card(TWO, SPADE),
				new Card(THREE, SPADE), new Card(FOUR, SPADE), new Card(FIVE, SPADE),
				new Card(SIX, SPADE), new Card(SEVEN, SPADE), new Card(EIGHT, SPADE),
				new Card(NINE, SPADE), new Card(TEN, SPADE), new Card(JACK, SPADE),
	...
	public void testIsWin() {
		...
		final Map<Suit, List<Card>> goal = new EnumMap<>(Suit.class);
		goal.put(CLUB, Arrays.asList(new Card(ACE, CLUB),
				new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB),
				new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB),
				new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB),
				new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(KING, CLUB)));
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND),
				new Card(TWO, DIAMOND), new Card(THREE, DIAMOND), new Card(FOUR, DIAMOND),
				new Card(FIVE, DIAMOND), new Card(SIX, DIAMOND), new Card(SEVEN, DIAMOND),
		...
		goal.put(HEART, Arrays.asList(new Card(ACE, HEART),
				new Card(TWO, HEART), new Card(THREE, HEART), new Card(FOUR, HEART),
				new Card(FIVE, HEART), new Card(SIX, HEART), new Card(SEVEN, HEART),
				new Card(EIGHT, HEART), new Card(NINE, HEART), new Card(TEN, HEART),
				new Card(JACK, HEART), new Card(QUEEN, HEART), new Card(KING, HEART)));
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE),
				new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE),
				new Card(FIVE, SPADE), new Card(SIX, SPADE), new Card(SEVEN, SPADE),
				new Card(EIGHT, SPADE), new Card(NINE, SPADE), new Card(TEN, SPADE),
				new Card(JACK, SPADE), new Card(QUEEN, SPADE), new Card(KING, SPADE)));
	...
	public void testIsWinMissingOneCard() {
		...
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND),
				new Card(TWO, DIAMOND), new Card(THREE, DIAMOND), new Card(FOUR, DIAMOND),
				new Card(FIVE, DIAMOND),                         new Card(SEVEN, DIAMOND),
				new Card(EIGHT, DIAMOND), new Card(NINE, DIAMOND), new Card(TEN, DIAMOND),
				new Card(JACK, DIAMOND), new Card(QUEEN, DIAMOND), new Card(KING, DIAMOND)));
		goal.put(HEART, Arrays.asList(new Card(ACE, HEART),
				new Card(TWO, HEART), new Card(THREE, HEART), new Card(FOUR, HEART),
	...
	public void testIsWinOneCardOnPiles() {
		...
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE),
				...
				new Card(FIVE, SPADE), new Card(SIX, SPADE), new Card(SEVEN, SPADE),
				new Card(EIGHT, SPADE), new Card(NINE, SPADE), new Card(TEN, SPADE),
				new Card(JACK, SPADE), new Card(QUEEN, SPADE)));
		final Board board = new Board(piles, drawPile, 0, goal);
	...
	public void testFindAllMoves1() {
		final List<Card> drawPile = Arrays.asList(
				...
				new Card(SEVEN, CLUB), new Card(JACK, CLUB), new Card(KING, CLUB),
				new Card(EIGHT, HEART), new Card(SIX, CLUB), new Card(QUEEN, SPADE),
				new Card(FIVE, DIAMOND), new Card(QUEEN, CLUB), new Card(SEVEN, DIAMOND),
				new Card(JACK, DIAMOND));
		final Card nil = null;
		final List<Pile> piles = new ArrayList<>(7);
		piles.add(new Pile(emptyListOfCards, Arrays.asList(new Card(SIX, DIAMOND))));
		piles.add(new Pile(Arrays.asList(nil), Arrays.asList(new Card(FOUR, DIAMOND), new Card(THREE, SPADE), new Card(TWO, HEART))));
		piles.add(new Pile(Arrays.asList(nil, nil), Arrays.asList(new Card(NINE, DIAMOND), new Card(EIGHT, SPADE), new Card(SEVEN, HEART))));
		piles.add(new Pile(Arrays.asList(nil, nil), Arrays.asList(new Card(THREE, HEART))));
		piles.add(new Pile(Arrays.asList(nil, nil, nil), Arrays.asList(new Card(FIVE, HEART), new Card(FOUR, CLUB), new Card(THREE, DIAMOND))));
	...
	public void testFindAllMoves2() {
		...
		piles.add(new Pile(Arrays.asList(new Card(QUEEN, HEART), new Card(TWO, DIAMOND)), Arrays.asList(new Card(NINE, DIAMOND))));
		piles.add(new Pile(Arrays.asList(new Card(FOUR, SPADE), new Card(FIVE, SPADE), new Card(THREE, HEART)), Arrays.asList(new Card(FOUR, CLUB))));
		piles.add(new Pile(Arrays.asList(new Card(JACK, HEART), new Card(SIX, SPADE), new Card(ACE, HEART), new Card(FIVE, HEART)), Arrays.asList(new Card(TWO, SPADE))));
		piles.add(new Pile(Arrays.asList(new Card(TEN, DIAMOND), new Card(KING, SPADE), new Card(TEN, SPADE), new Card(JACK, SPADE), new Card(KING, HEART)), Arrays.asList(new Card(NINE, HEART))));
		piles.add(new Pile(Arrays.asList(new Card(FIVE, CLUB), new Card(KING, DIAMOND), new Card(TEN, CLUB), new Card(TEN, HEART), new Card(SIX, HEART), new Card(FOUR, HEART)), Arrays.asList(new Card(SEVEN, HEART))));
