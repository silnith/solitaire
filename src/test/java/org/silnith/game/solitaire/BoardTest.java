...
public class BoardTest {
	...
	public void testEqualsOneStack() {
		final List<Card> stack = Arrays.asList(new Card(KING, CLUB), new Card(QUEEN, DIAMOND), new Card(JACK, SPADE), new Card(TEN, HEART));
	...
	public void testEqualsTwoStacks() {
		final List<Card> stack1 = Arrays.asList(new Card(KING, CLUB), new Card(QUEEN, DIAMOND), new Card(JACK, SPADE), new Card(TEN, HEART));
	...
	public void testEqualsDrawPile() {
		final List<Card> drawPile = Arrays.asList(new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(EIGHT, HEART), new Card(EIGHT, CLUB), new Card(EIGHT, DIAMOND), new Card(KING, DIAMOND), new Card(QUEEN, CLUB), new Card(ACE, HEART));
	...
	public void testNotEqualsDrawPile() {
		final List<Card> drawPile1 = Arrays.asList(new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(EIGHT, HEART), new Card(EIGHT, CLUB), new Card(EIGHT, DIAMOND), new Card(KING, DIAMOND), new Card(QUEEN, CLUB), new Card(ACE, HEART));
		final List<Card> drawPile2 = Arrays.asList(new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(EIGHT, CLUB), new Card(EIGHT, DIAMOND), new Card(KING, DIAMOND), new Card(QUEEN, CLUB), new Card(ACE, HEART));
	...
	public void testEqualsGoal() {
		...
		goal.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB), new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB), new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB), new Card(JACK, CLUB), new Card(QUEEN, CLUB)));
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND)));
		goal.put(HEART, Arrays.asList(new Card(ACE, HEART), new Card(TWO, HEART), new Card(THREE, HEART), new Card(FOUR, HEART)));
	...
	public void testEqualsGoalCopy() {
		...
		goal1.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB), new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB), new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB), new Card(JACK, CLUB), new Card(QUEEN, CLUB)));
		goal1.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND)));
		goal1.put(HEART, Arrays.asList(new Card(ACE, HEART), new Card(TWO, HEART), new Card(THREE, HEART), new Card(FOUR, HEART)));
		goal1.put(SPADE, Arrays.asList(new Card[] {}));
		
		final Map<Suit, List<Card>> goal2 = new EnumMap<>(Suit.class);
		goal2.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB), new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB), new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB), new Card(JACK, CLUB), new Card(QUEEN, CLUB)));
		goal2.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND)));
		goal2.put(HEART, Arrays.asList(new Card(ACE, HEART), new Card(TWO, HEART), new Card(THREE, HEART), new Card(FOUR, HEART)));
	...
	public void testMoveStackBig() {
		final List<Card> stack = Arrays.asList(new Card(KING, HEART), new Card(QUEEN, CLUB), new Card(JACK, HEART), new Card(TEN, CLUB), new Card(NINE, HEART));
	...
	public void testMoveStackOntoAnother() {
		...
		final List<Card> bottomStack = Arrays.asList(new Card(FIVE, HEART), new Card(FOUR, CLUB), new Card(THREE, HEART));
		final List<Card> combinedStack = Arrays.asList(new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, HEART), new Card(FOUR, CLUB), new Card(THREE, HEART));
	...
	public void testMoveStackPartialOntoAnother() {
		final List<Card> topStack = Arrays.asList(new Card(SEVEN, HEART), new Card(SIX, CLUB));
		final List<Card> bottomStack = Arrays.asList(new Card(SIX, SPADE), new Card(FIVE, HEART), new Card(FOUR, CLUB), new Card(THREE, HEART));
		final List<Card> combinedStack = Arrays.asList(new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, HEART), new Card(FOUR, CLUB), new Card(THREE, HEART));
	...
	public void testMoveStackKeepsDrawPile() {
		final List<Card> stack = Arrays.asList(new Card(KING, SPADE));
		final List<Card> drawPile = Arrays.asList(new Card(TWO, CLUB), new Card(TEN, SPADE), new Card(THREE, SPADE), new Card(THREE, HEART));
	...
	public void testMoveCardToGoalNonEmptyGoal() {
		final Map<Suit, List<Card>> expectedGoal = new EnumMap<>(emptyGoal);
		expectedGoal.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB)));
		final Board expectedBoard = new Board(emptyPiles, emptyListOfCards, 0, expectedGoal);
	...
	public void testDrawCardToPileNonEmpty() {
		final List<Pile> expectedPiles = new ArrayList<>(emptyPiles);
		expectedPiles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND), new Card(FOUR, SPADE))));
		final Board expectedBoard = new Board(expectedPiles, emptyListOfCards, 0, emptyGoal);
		
		final List<Card> drawPile = Arrays.asList(new Card(FOUR, SPADE));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND))));
	...
	public void testDrawCardToPileFromBeginningNonEmpty() {
		final List<Card> expectedDrawPile = Arrays.asList(new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB));
		final List<Pile> expectedPiles = new ArrayList<>(emptyPiles);
		expectedPiles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND), new Card(FOUR, SPADE))));
		final Board expectedBoard = new Board(expectedPiles, expectedDrawPile, 0, emptyGoal);
		
		final List<Card> drawPile = Arrays.asList(new Card(FOUR, SPADE), new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND))));
		final Board board = new Board(piles, drawPile, 1, emptyGoal);
	...
	public void testDrawCardToPileFromMiddleNonEmpty() {
		...
		final List<Card> drawPile = Arrays.asList(new Card(SIX, SPADE), new Card(FOUR, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND))));
	...
	public void testDrawCardToPileFromEndNonEmpty() {
		...
		final List<Card> drawPile = Arrays.asList(new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(FOUR, SPADE));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(4, new Pile(null, Arrays.asList(new Card(EIGHT, SPADE), new Card(SEVEN, HEART), new Card(SIX, CLUB), new Card(FIVE, DIAMOND))));
	...
	public void testDrawCardToGoalNonEmpty() {
		...
		expectedGoal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE), new Card(FIVE, SPADE)));
		final Board expectedBoard = new Board(emptyPiles, emptyListOfCards, 0, expectedGoal);
		
		final Map<Suit, List<Card>> goal = new EnumMap<>(emptyGoal);
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND), new Card(TWO, DIAMOND)));
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE)));
	...
	public void testDrawCardToGoalFromBeginningNonEmpty() {
		...
		expectedGoal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND), new Card(TWO, DIAMOND)));
		expectedGoal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE), new Card(FIVE, SPADE)));
		final List<Card> expectedDrawPile = Arrays.asList(new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(TWO, HEART), new Card(TEN, DIAMOND));
		final Board expectedBoard = new Board(emptyPiles, expectedDrawPile, 0, expectedGoal);
		
		final Map<Suit, List<Card>> goal = new EnumMap<>(emptyGoal);
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND), new Card(TWO, DIAMOND)));
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE)));
		final List<Card> drawPile = Arrays.asList(new Card(FIVE, SPADE), new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(TWO, HEART), new Card(TEN, DIAMOND));
		final Board board = new Board(emptyPiles, drawPile, 1, goal);
	...
	public void testDrawCardToGoalFromMiddleNonEmpty() {
		...
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND), new Card(TWO, DIAMOND)));
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE)));
		final List<Card> drawPile = Arrays.asList(new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(FIVE, SPADE), new Card(QUEEN, CLUB), new Card(TWO, HEART), new Card(TEN, DIAMOND));
	...
	public void testDrawCardToGoalFromEndNonEmpty() {
		...
		goal.put(DIAMOND, Arrays.asList(new Card(ACE, DIAMOND), new Card(TWO, DIAMOND)));
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE), new Card(TWO, SPADE), new Card(THREE, SPADE), new Card(FOUR, SPADE)));
		final List<Card> drawPile = Arrays.asList(new Card(SIX, SPADE), new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(TWO, HEART), new Card(TEN, DIAMOND), new Card(FIVE, SPADE));
	...
	public void testDrawCardToGoalKeepsPiles() {
		...
		goal.put(SPADE, Arrays.asList(new Card(ACE, SPADE)));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(1, new Pile(null, Arrays.asList(new Card(FOUR, DIAMOND), new Card(THREE, SPADE), new Card(TWO, DIAMOND), new Card(ACE, SPADE))));
		piles.set(2, new Pile(Arrays.asList(new Card(FOUR, CLUB), new Card(TEN, DIAMOND)), Arrays.asList(new Card(TEN, CLUB), new Card(NINE, HEART), new Card(EIGHT, CLUB), new Card(SEVEN, HEART))));
		final Board expectedBoard = new Board(piles, emptyListOfCards, 0, goal);
	...
	public void testMoveCardFromGoal() {
		final Map<Suit, List<Card>> expectedGoal = new EnumMap<>(emptyGoal);
		expectedGoal.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB), new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB), new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB), new Card(JACK, CLUB), new Card(QUEEN, CLUB)));
		final List<Pile> expectedPiles = new ArrayList<>(emptyPiles);
		...
		final Map<Suit, List<Card>> goal = new EnumMap<>(emptyGoal);
		goal.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB), new Card(FOUR, CLUB), new Card(FIVE, CLUB), new Card(SIX, CLUB), new Card(SEVEN, CLUB), new Card(EIGHT, CLUB), new Card(NINE, CLUB), new Card(TEN, CLUB), new Card(JACK, CLUB), new Card(QUEEN, CLUB), new Card(KING, CLUB)));
	...
	public void testMoveCardFromGoalNonEmptyPile() {
		...
		final List<Pile> expectedPiles = new ArrayList<>(emptyPiles);
		expectedPiles.set(3, new Pile(Arrays.asList(new Card(FOUR, SPADE)), Arrays.asList(new Card(SIX, HEART), new Card(FIVE, SPADE), new Card(FOUR, HEART), new Card(THREE, CLUB))));
		final Board expectedBoard = new Board(expectedPiles, emptyListOfCards, 0, expectedGoal);
		
		final Map<Suit, List<Card>> goal = new EnumMap<>(emptyGoal);
		goal.put(CLUB, Arrays.asList(new Card(ACE, CLUB), new Card(TWO, CLUB), new Card(THREE, CLUB)));
		final List<Pile> piles = new ArrayList<>(emptyPiles);
		piles.set(3, new Pile(Arrays.asList(new Card(FOUR, SPADE)), Arrays.asList(new Card(SIX, HEART), new Card(FIVE, SPADE), new Card(FOUR, HEART))));
		final Board board = new Board(piles, emptyListOfCards, 0, goal);
