...
//					e.printStackTrace();
	...
	public static void main(final String[] args) throws InterruptedException {
		ApplicationContext context = new AnnotationConfigApplicationContext(SearcherConfiguration.class);
		
		final List<Card> deck = (List<Card>) context.getBean("deck", List.class);
...
//			System.out.println("Cycles detected: " + formatter.format(solitaire.cyclesDetected.get()));
//			System.out.println("Draw advances coalesced: " + formatter.format(searcher.drawAdvancesCoalesced.get()));
//			System.out.println("Pile moves after draw advance pruned: " + formatter.format(searcher.pileMoveAfterDrawAdvancePrune.get()));
//			System.out.println("Repeated moves of the same pile pruned: " + formatter.format(searcher.samePileMovedTwicePrune.get()));
