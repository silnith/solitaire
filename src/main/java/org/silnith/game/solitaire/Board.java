...
//		this.goal = Collections.unmodifiableMap(tempGoal);
	 ...
	 */
	protected Board(final List<Pile> piles, final List<Card> drawPile, final int drawIndex, final Map<Suit, List<Card>> goal) {
		super();
		this.piles = piles;
	...
	public boolean equals(final Object obj) {
		if (obj instanceof Board) {
			...
			return drawIndex == board.drawIndex && piles.equals(board.piles)
					&& goal.equals(board.goal) && drawPile.equals(board.drawPile);
		} else {
			return false;
		}
	}
